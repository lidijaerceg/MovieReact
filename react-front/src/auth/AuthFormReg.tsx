...
export default function AuthFormReg(props: authFormProps) {
  return (
    <Formik
    ...
    >
      {(formikProps) => (
        <Form>
          ...
          <TextField displayName="Confirm Password" field="confirmPassword" type="password" />
          Role:
...
interface authFormProps {
  ...
  onSubmit(
    vales: userCredentialsReg,
    action: FormikHelpers<userCredentialsReg>
  ): void;
}
